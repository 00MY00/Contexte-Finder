...
def Extract_Context(filepath, ResumWordSiz, FeirstContextTriger, MaxContextWords):
...
# Example
#config = Extract_Context('..\DOCs\Biographie_Fictive_Marie_Lefebvre.txt')   # Recupère du contexte du fichier
#print(config)